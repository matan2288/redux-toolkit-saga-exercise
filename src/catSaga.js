...
// take > wait for an action, an event to occur, and take as argument a string that is not a function of the action, but an action.type(e.g. take(GET_USERS_SUCCESS) action.type).
// takeEvery > watch our funtion/action and trigger a function whenever an action/function being called (e.g. takeEvery(action.type, generatorFucntionToRun)
